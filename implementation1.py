...
class Main:
    ...
    background = pygame.image.load('"C:\Users\komal\OneDrive\ALL SUBJECT\Capstone\mod_int.png"')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load('"C:\Users\komal\OneDrive\ALL SUBJECT\Capstone\red.png"')
    yellowSignal = pygame.image.load('"C:\Users\komal\OneDrive\ALL SUBJECT\Capstone\yellow.png"')
    greenSignal = pygame.image.load('"C:\Users\komal\OneDrive\ALL SUBJECT\Capstone\green.png"')
